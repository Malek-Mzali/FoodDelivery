...
import {doc, orderBy, collection, query, getDocs} from "firebase/firestore";
    ...
    getDocs(orderedQuery)
        .then((querySnapshot) => {
          querySnapshot.forEach((docs) => {
            if (docs.data().id === auth.currentUser.uid)
              orders.push({
                id: docs.data().id,
                title: docs.data().username,
                data: {
                  email: docs.data().email,
                  phone: docs.data().phone,
                  adress: docs.data().Adress,
                  hand: docs.data().hand,
                  state: docs.data().state,
                  order: docs.data().items,
                  Date: docs.data().time,
                },
              });
